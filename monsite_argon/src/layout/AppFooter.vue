    ...
    <footer class="footer has-cards">
        ...
        <div class="container">
            <div class="row row-grid align-items-center my-md">
                <div class="col-lg-6">
                    <h3 class="text-primary font-weight-light mb-2">Merci de votre soutient !!</h3>
                    <h4 class="mb-0 font-weight-light">Vous pouvez également nous retrouver sur les reseaux sociaux --></h4>
                </div>
            ...
            <div class="row align-items-center justify-content-md-between">
                <div class="col-md-6">
                    <div class="copyright">
                        &copy; {{year}}
                        <p>Company, Inc. &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <ul class="nav nav-footer justify-content-end">
                        <li class="nav-item">
                            <a href="#" class="nav-link" target="_blank" rel="noopener">Accueil</a>
                        </li>
                        <li class="nav-item">
                            <router-link to="Login" class="nav-link" target="_blank" rel="noopener">S'identifier</router-link>
                        </li>
                    </ul>
                </div>
            </div>
